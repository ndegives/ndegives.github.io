...
La prédiction par distance inverse est un prédicteur exact qui possède l’avantage de prendre en compte la distance entre le point prédit et les échantillons.
